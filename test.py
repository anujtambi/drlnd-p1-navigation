""" A script for testing the agent in the Banana environment of Udacity Deep Reinforcement Learning nanodegree (Project 1).
The first command-line argument is the saved weights generated by the training script (train.py)
