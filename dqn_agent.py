"""" A reinforcement learning agent implementing Deep Q-Network (DQN),
based on the reference implementation provided in Udacity Deep Reinforcement Learning nanodegree.

Modified to also implement Double DQN, as described in 

https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf

The hyper parameter UPDATE_EVERY was changed to 25, to improve training in the target environment (Bananas) 
"""
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, use_ddqn=True):
        ...
        ======
            ...
            use_ddqn(boolean): use variant Double DQN instead of vanilla DQN
        """
    ...
    def learn(self, experiences, gamma):
        ...
        if (self.use_ddqn):
            # Double DQN
            # Get best actions based on local network
